...
//             std::endl; if (it->key().ToString() == std::to_string(end_key)) {
//               break;
//             }
//           }
//           if (!it->status().ok()) {
...
//   // // Close DB in a way of detecting errors
//   // // followed by deleting the database object when examined to determine
//   if
//   // there were any errors.
//   // // Regardless of errors, it will release all resources and is
//   irreversible.
//   // // Flush the memtable before close
//   // Status CloseDB(DB *&db, const FlushOptions &flush_op);
...
//   std::cout << "total time spent in all operations: " <<
//   cum_time_all_operations
...
//   std::cout << "total time spent for range queries: " <<
//   cum_time_range_queries
